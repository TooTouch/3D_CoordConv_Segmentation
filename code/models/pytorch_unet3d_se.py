...
#             self.include_label_wise_dice_coefficients = True
        ...
        self.se1 = SE(self.n_base_filters*(2**4), 2)
...
#        print("pool3",pool3.shape)
 ...
 #       print("Starting SE shape",env4_1.shape)
        env4_1 = SE_block(env4_1,self.se1)
  #      print("SE finished",env4_1.shape)
